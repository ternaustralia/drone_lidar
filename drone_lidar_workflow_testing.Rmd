...
Email: poornima.sivanandam@utas.edu.au  
#### Summary
...
3.  Update default/hardcoded settings as required:
...
```{r dir paths}
#
# USER INPUT REQUIRED for input folder containing las file and output folder for intermediate files and results
#
in_dir = r"(F:\testing_lidar\20230215_Swansea\lidars\terra_las)"

out_dir = r"(F:\lidr_workflow\20230215_Swansea\outputs\)"
tmp_dir = r"(F:\lidr_workflow\20230215_Swansea\tmp\)"
...
# https://github.com/r-lidar/lidRbook/
...
# Using default values, width = 5 m, cross section along x-axis
plot_transect(las)
...
#edit these options to plot last returns or other z thresholds
